    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `CoinModel` (`id` TEXT, `symbol` TEXT, `name` TEXT, `image` TEXT, `currentPrice` TEXT, `marketCapRank` TEXT, `marketCapChangePercentage24h` REAL, `atlDate` TEXT, `lastUpdated` TEXT, PRIMARY KEY (`id`))');
...
class _$CoinDao extends CoinDao {
  ...
  @override
  Future<List<CoinModel>> listAllCoin() async {
